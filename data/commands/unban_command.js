...
module.exports.run = (Bot, msg, args) => {
    (async () => {
        ...
        if(runningBan){ return msg.channel.send(`A ban is already in progress, please wait until it overs!`); }
        else if(runningUnban){ return msg.channel.send(`An unban is already in progress, please wait until it overs!`); }
